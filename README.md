...
<!-- [![Build Status](https://img.shields.io/travis/kasir-barati/migrate-mongo.svg?style=flat)](https://travis-ci.org/kasir-barati/migrate-mongo) [![Coverage Status](https://coveralls.io/repos/github/kasir-barati/migrate-mongo/badge.svg?branch=master)](https://coveralls.io/r/kasir-barati/migrate-mongo) [![NPM](https://img.shields.io/npm/v/migrate-mongo.svg?style=flat)](https://www.npmjs.org/package/migrate-mongo) [![Downloads](https://img.shields.io/npm/dm/migrate-mongo.svg?style=flat)](https://www.npmjs.org/package/migrate-mongo) [![Dependencies](https://david-dm.org/kasir-barati/migrate-mongo.svg)](https://david-dm.org/kasir-barati/migrate-mongo) [![Known Vulnerabilities](https://snyk.io/test/github/kasir-barati/migrate-mongo/badge.svg)](https://snyk.io/test/github/kasir-barati/migrate-mongo) -->
